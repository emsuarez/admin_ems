...
export const getEjecutivoAction =
  ...
  async dispatch => {
    try {
      ...
      console.error(`getEjecutivoAction: ${error}`)
      progress.finish()
    }
  }
...
export const getAllEjecutivosAction = () => async dispatch => {
  try {
    ...
    console.error(`getAllEjecutivosAction: ${error}`)
    progress.finish()
  }
}
...
export const getGrupoFamiliarAction =
  ...
  async dispatch => {
    try {
      ...
      console.error(`getGrupoFamiliarAction: ${error}`)
      progress.finish()
    }
  }
...
export const getAllFamiliaresAction = () => async dispatch => {
  try {
    ...
    console.error(`getAllFamiliaresAction: ${error}`)
    progress.finish()
  }
}
...
export const getGrupoFamiliarByIdAction = data => async dispatch => {
  try {
    ...
    console.error(`getGrupoFamiliarByIdAction: ${error}`)
    progress.finish()
  }
}
...
export const GetLugaresAction =
  ...
  async dispatch => {
    try {
      ...
      console.error(`GetLugaresAction: ${error}`)
      progress.finish()
    }
  }
...
export const GetAllLugaresAction = () => async dispatch => {
  try {
    ...
    console.error(`GetAllLugaresAction: ${error}`)
    progress.finish()
  }
}
...
export const getVehiculoEjecutivoAction =
  ...
  async dispatch => {
    try {
      ...
      console.error(`getVehiculoEjecutivoAction: ${error.message}`)
      progress.finish()
    }
  }
...
export const getAllVehiculosEjecutivoAction = () => async dispatch => {
  try {
    ...
    console.error(`getAllVehiculosEjecutivoAction: ${error.message}`)
    progress.finish()
  }
}
...
export const getProtectoresAction =
  ...
  async dispatch => {
    try {
      ...
      console.error(`getProtectoresAction: ${error.message}`)
      progress.finish()
    }
  }
...
export const getAllProtectoresAction = () => async dispatch => {
  try {
    ...
    console.error(`getAllProtectoresAction: ${error.message}`)
    progress.finish()
  }
}
...
export const getVehiculoProtectorAction =
  ...
  async dispatch => {
    try {
      ...
      console.error(`getVehiculoProtectorAction: ${error.message}`)
      progress.finish()
    }
  }
...
export const getAllVehiculoProtectorAction = () => async dispatch => {
  try {
    ...
    const result = response.data
    dispatch({
      type: types.GET_ALLVEHICULOEPROTECTOR_SUCCESS,
      payload: result,
    })
    progress.finish()
  } catch (error) {
    dispatch({ type: types.GET_ALLVEHICULOEPROTECTOR_FAILED })
    console.error(`getAllVehiculoProtectorAction: ${error.message}`)
    progress.finish()
  }
}
