        ...
        <table className='items-center bg-transparent w-full border-collapse'>
          <thead className='border-gray-200'>
            <tr>
              ...
              <th className='px-6 bg-blueGray-50 text-blue-900 align-middle border border-solid border-blueGray-100 py-3 text-base uppercase border-l-0 border-r-0 whitespace-nowrap font-semibold text-center'>
                Opciones
              </th>
            </tr>
          </thead>
            ...
            <tbody className='overflow-x-auto'>
              {results.map(item => (
                <tr key={item.user_id}>
                  ...
                  <td className='flex'>
                    <img
                      src={`${global.urlMedia}${item.imagen}`}
                      alt={item.username}
                      className='rounded-full mt-0.5 w-6 h-6 object-cover'
                    />

                    <label className='border-t-0 px-2 align-middle border-l-0 border-r-0 text-base whitespace-nowrap hover:cursor-pointer text-white mx-auto hover:bg-gray-300 hover:rounded flex items-center'>
                      <svg
                        width='22'
                        height='22'
                        viewBox='0 0 22 22'
              ...
              <CambiarImagenModal
                tituloModal={'Actualizar imagen'}
                descripcionModal={`Esta seguro de modificar la imagen del usuario`}
                openModal={openModal}
        ...
        <div className='hidden sm:flex-1 sm:flex sm:items-center sm:justify-between'>
          ...
          <div>
            ...
            ? cantidadPaginas.map(pagina => (
                <a
                  href='#'
                  className='py-2 px-3 leading-tight text-gray-500 bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white'
                >
                  {pagina}
                </a>
              ))
