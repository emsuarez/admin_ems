            ...
            <ul className=" w-80 space-y-4" ref={wrapperRef}>
              ...
              (window.location.href!==window.location.protocol + '//' + window.location.host+"/admin/historial")&&
                ...
                </li>
                {
                  ...
                  <li onClick={()=>toogleSubTooltip()} className="flex space-x-4 hover:border-l-4 border-blue-500 hover:cursor-pointer hover:bg-slate-200 h-10 ">
                  <p className="text-sm mt-3 ml-3">Entrega y recepciónde turno</p>
                  <ICONS.ChevronRightIconO className="h-4 mt-3 ml-3" color="blue"/>
                  </li>
        }
        ...
        title={
          <React.Fragment>
            <ul className=" w-80 space-y-4">
                ...
                <li onClick={()=>navigate('/cctv/diurno')} className="flex space-x-4 hover:border-l-4 border-blue-500 hover:cursor-pointer hover:bg-slate-200 h-10 ">
                    {/* <ICONS.PencilAltIconS className="h-4 mt-3 ml-3" color="blue"/> */}
                    <p className="text-sm  mt-3 ml-3">Diurno</p>
                </li>
                {
                  item=="cctv"&&
                  <li onClick={()=>navigate('/cctv/nocturno')} className="flex space-x-4 hover:border-l-4 border-blue-500 hover:cursor-pointer hover:bg-slate-200 h-10 ">
