...
const controlMovimientoReportPDF = historialControlMovimiento => {
  console.log(historialControlMovimiento, 'controlMovimiento')
  // initialize jsPDF
  const doc = new jsPDF()
  ...
  doc.save(`report_historial_control_movimiento_${dateStr}.pdf`)
}

export default controlMovimientoReportPDF
