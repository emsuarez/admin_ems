...
import { AdminAuthorized, CreateEjecutivo, EjectivosTable, FamilyTable, Header, ICONS, RedirectWithoutLogin, VehiculosEjecutivoTable, VehiculosTable } from '../../components'
        ...
        <div className='h-screen'>
            ...
            <Header items="all"/>
                <div className='flex items-center bg-slate-100 shadow-sm py-2'>
                    ...
                    <p className=' ml-1'>Vehículos de ejecutivos</p>
                </div>


                <div className='flex ml-16 mt-4'>
                    <h4 className='font-semibold'>Vehículos de ejecutivos</h4>
