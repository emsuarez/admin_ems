...
import { AdminAuthorized, CreateEjecutivo, EjectivosTable, FamilyTable, Header, ICONS, ProtectoresTable, RedirectWithoutLogin } from '../../components'
        ...
        <div className='h-screen'>
            ...
            <Header items="all"/>
                ...
                <div className='flex ml-11 mt-4'>
                    <h4 className='font-semibold'>Protectores</h4>
