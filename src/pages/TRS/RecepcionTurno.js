...
import { AdminAuthorized, Header, HistorialMovimientoTable, ICONS, RecepcionTurnoTable, RedirectWithoutLogin } from '../../components'
        ...
        <div className='h-screen'>
            ...
            <Header items="all"/>
                ...
                <div className='flex ml-11 mt-4'>
                    <h4 className='font-semibold'>Entrega y recepción de turno</h4>
